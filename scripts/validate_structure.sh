...
REQUIRED_PATHS=(
    ...
    ".github/agents/enrich-data-story-user.agent.md"
    ".github/prompts/02-enrich-data-story-user.prompt.md"
    ".github/skills/data-story-user-enrichment/SKILL.md"
    ".claude/agents/enrich-data-story-user.md"
    ".claude/skills/data-story-user-enrichment/SKILL.md"
